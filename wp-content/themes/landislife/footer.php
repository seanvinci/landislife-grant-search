    ...
    <div class="footer-contact medium-4 columns">
      <ul>
        ...
        <li class="columns nopad">
          <a class="break" href="tel:1-646-812-6255">+1.646.812.6255</a>
          <a href="mailto:info@landislife.org">info@landislife.org</a>
        </li>
        ...
        <li class="footer-credits columns nopad">
          Photo credits:<br/>
          <a href="http://www.nicolasvillaume.com/" target="_blank">Nicolas Villaume</a> and<br/>
          <a href="http://www.gleb-raygorodetsky.com/" target="_blank">Gleb Raygorodetsky</a>
        </li>
      </ul>
    </div>
  ...
  <div class="footer-legal row tac">
    <div class="columns">
      ...
      <div>
        ...
        &copy;2017 by Land is Life. Made with ♡ in NYC by <a href="http://flightstudio1.com/">FlightStudio1</a>
      </div>
    </div>
  </div>
</footer>
