...
class Search_Filter_Display_Shortcode {
    ...
    private function get_field($field_data, $post_types, $search_form_id)
    {
        ...
        $returnvar .= "<li class=\"medium-4 large-3 columns $field_class\" data-sf-field-name=\"$field_name\" data-sf-field-type=\"".$field_data['type']."\" data-sf-field-input-type=\"".$input_type."\"".$addAttributes.">";
        ...
        if(isset($field_data['heading']))
        {
            ...
            {
                $returnvar .= "<div class=\"input-text\">".esc_html($field_data['heading'])."</div>";
            }
        }
